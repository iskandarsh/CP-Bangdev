...
const SectionHero: React.FC = () => {
  return (
    <>
      <section className="mt-20 flex flex-col-reverse items-center justify-center md:flex-row" id="hero">
        <div className="flex w-full flex-col justify-center pl-10 md:w-5/12">
          <div>
            ...
            <a href="" className="bg-main text-small rounded-[10px] px-3 py-2 text-white">
